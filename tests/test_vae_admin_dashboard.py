...
class VaeAdminDashboardTests(unittest.TestCase):
    ...
    def test_vae_dashboard_filters_have_runtime_dependencies(self):
        ...
        self.assertIn('data-vae-dashboard-filter="l2_validated"', html)
        self.assertIn('data-vae-dashboard-count="l2_validated"', html)
        self.assertNotIn('data-vae-dashboard-count="status:livret_2_validated"', html)
        ...
        self.assertIn('status === "livret_2_validated" || status === "financement_l2_validated"', html)
        self.assertIn('activeVaeDashboardFilter === "l2_validated" && (rowVaeStatus === "livret_2_validated" || rowVaeStatus === "financement_l2_validated")', html)
        self.assertIn('activeVaeDashboardFilter === "new_vae_request_72h" || activeVaeDashboardFilter === "l2_validated"', html)
