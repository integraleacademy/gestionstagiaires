...
class VaeAdminDashboardTests(unittest.TestCase):
    ...
    def test_vae_dashboard_filters_have_runtime_dependencies(self):
        ...
        self.assertIn('data-vae-dashboard-count="status:livret_2_validated"', html)
        ...
        self.assertIn('function isLivret2ValidatedDashboardStatus(status)', html)
        self.assertIn('counts["status:livret_2_validated"] = (counts["status:livret_2_validated"] || 0) + 1;', html)
